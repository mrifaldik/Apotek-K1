        ...
        <div class="wrapper-box">
            ...
            <nav class="side-nav">
                <ul>
                    ...
                    <li>
                        <a href="<?= base_url('categories/obatbebas') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="file-text"></i> </div>
                            <div class="side-menu__title"> Obat Bebas </div>
                        </a>
                    </li>
                    <li>
                        <a href="<?= base_url('categories/obatbebasterbatas') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="file-text"></i> </div>
                            <div class="side-menu__title"> Obat Bebas Terbatas </div>
                        </a>
                    </li>

                    <li>
                        <a href="<?= base_url('categories/obatkeras') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="file-text"></i> </div>
                            <div class="side-menu__title"> Obat Keras </div>
                        </a>
                    </li>

                    <li>
                        <a href="<?= base_url('categories/obatherbal') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="file-text"></i> </div>
                            <div class="side-menu__title"> Obat Herbal </div>
                        </a>
                    </li>
